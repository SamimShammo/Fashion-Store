...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product ">
            ...
            <div class="card d-flex align-itmes-center shadow  " style=" height:520px; border: 0 ">
              <img src="${image}" class="card-img-top  p-2 product-image  w-50  mx-auto" alt="..." >
...
//allPriceTotal update function
const updateTotal = () => {
  const allPriceTotal = getInputValue("price") + getInputValue("delivery-charge") +
  getInputValue("total-tax");
  
  document.getElementById("total").innerText = allPriceTotal.toFixed(2);
  
};
// buyNow confirm payment 
const buyNow = () =>{
   confirm('Please Confirm Your Payment')
}
//allPriceTotal update function
loadProducts();
